...
<table class="table table-borderer border-dark-subtle table-danger" border="2px">
  ...
  <tbody>
    ...
    while ($valores=mysqli_fetch_array($r)){
      echo("<tr>");
      echo("<th scope=col><a href='../modificar/modificar5.php?id_medicamento=" .$valores['id_medicamento'] . "&funcion=M'><img src='../img/pencil-square.svg'></a></th>");
      echo("<td>") . ("</td>") ;
      echo("<td>" . $valores["id_medicamento"] . "</td>" );
