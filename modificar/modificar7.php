...
$id=$_GET['id_stock'];
$q="SELECT * from stock where id_stock=$id";
...
<br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                <form action="modificar8.php" method="GET">
                <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">ID</label>
                        <input type="text" name="id" class="form-control" id="exampleImputPassword1"  hidden="true" value= <?php echo($valores["id_stock"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">ID paciente</label>
                        <input type="text" name="id_paciente" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["id_paciente"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputPassword1" class="form-label">ID medicacion</label>
                        <input type="text" name="id_medicaion" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["id_medicacion"]); ?>>
                    </div>
                    <div class="mb-5">
