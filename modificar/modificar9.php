...
$id=$_GET['id_alerta'];
$q="SELECT * from alertas where id_alerta=$id";
...
<br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                <form action="modificar10.php" method="GET">
                <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">ID</label>
                        <input type="text" name="id" class="form-control" id="exampleImputPassword1"  hidden="true" value= <?php echo($valores["id_alerta"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">Horario</label>
                        <input type="text" name="horario" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["horario"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputPassword1" class="form-label">Fecha</label>
                        <input type="text" name="fecha" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["fecha"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">ID trabajador</label>
                        <input type="text" name="trabajador" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["id_trabajador"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">ID medicacion</label>
                        <input type="text" name="medicacion" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["id_medicacion"]); ?>>
                    </div>
                    <div class="mb-5">
                        <label for="exampleInputEmail1" class="form-label">ID paciente</label>
                        <input type="text" name="paciente" class="form-control" id="exampleImputPassword1" value= <?php echo($valores["id_paciente"]); ?>>
                    </div>
